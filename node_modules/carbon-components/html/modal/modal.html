...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ozf7n0a05di">Show
  modal</button>

<div data-modal id="modal-ozf7n0a05di" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ozf7n0a05di-label" aria-describedby="modal-ozf7n0a05di-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ozf7n0a05di-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ozf7n0a05di-heading">Modal heading</p>
