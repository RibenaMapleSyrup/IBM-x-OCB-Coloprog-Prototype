...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-fkx2img08k">Show
  modal</button>

<div data-modal id="modal-fkx2img08k" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-fkx2img08k-label" aria-describedby="modal-fkx2img08k-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fkx2img08k-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fkx2img08k-heading">Modal heading</p>
