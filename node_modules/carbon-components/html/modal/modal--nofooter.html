...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-31lkba925lo">Show
  modal</button>

<div data-modal id="modal-31lkba925lo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-31lkba925lo-label" aria-describedby="modal-31lkba925lo-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-31lkba925lo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-31lkba925lo-heading">Modal heading</p>
